            ...
            <div class="form-group">
                <select class="form-control selectpicker" name="cities[]" data-live-search="true" multiple required>
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($city->id); ?>" <?php if(old('cities') == $city->id): ?> selected <?php endif; ?>><?php echo e($city->name); ?></option>
...
<?php /**PATH E:\Xampp\htdocs\water\resources\views/company/register.blade.php ENDPATH**/ ?>