                        ...
                        <div class="row">
                            ...
                            <form class="form-inline" action="">
                                <div class="col-lg-2">
                                    ...
                                    <input value="<?php echo e(request('search') ?? ''); ?>" type="search" name="search" placeholder="ابحث عن منتج معين   "
                                           class="form-control">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('company.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\coding\xampp\htdocs\water\resources\views/company/products/index.blade.php ENDPATH**/ ?>