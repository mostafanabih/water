...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <div class="col-lg-9">
                                        <div class="ibox float-e-margins">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-8"><p><?php echo e($order->location); ?></p></div>
                                            </div>
                                            <div class="col-sm-12">
    ...
    <div class="modal inmodal" id="stop" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content  animated bounceInRight"  aria-hidden="true" style=" padding: 1em;">
                <form action="<?php echo e(url('company/cancelorder/'.$order->id)); ?>"  method="post" class="form-horizontal">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal inmodal" id="confirm" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content  animated bounceInRight"  aria-hidden="true" style=" padding: 1em;">
                <form action="<?php echo e(url('company/confirmorder/'.$order->id)); ?>" method="post" class="form-horizontal">
                    <?php echo csrf_field(); ?>
                    <?php echo e(method_field('PUT')); ?>

                    <div class="form-group"><label class="col-sm-4 control-label" > المندوب </label>
                        <div class="col-sm-8">
                            <select name="representative" id="my_representative" class="form-control" required>
                                <option value="">اختر مندوب لتحويل الطلب اليه ...</option>
                                <?php $__currentLoopData = $order->Company->Representatives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $representative): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('company.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\coding\xampp\htdocs\water\resources\views/company/orders/orderdetails.blade.php ENDPATH**/ ?>