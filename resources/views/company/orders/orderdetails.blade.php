...
@section('content')
                                    ...
                                    <div class="col-lg-9">
                                        <div class="ibox float-e-margins">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-8"><p>{{$order->location}}</p></div>
                                            </div>
                                            <div class="col-sm-12">
    ...
    <div class="modal inmodal" id="stop" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content  animated bounceInRight"  aria-hidden="true" style=" padding: 1em;">
                <form action="{{url('company/cancelorder/'.$order->id)}}"  method="post" class="form-horizontal">
                    @csrf
                    {{method_field('PUT')}}
                    <div>
    ...
    <div class="modal inmodal" id="confirm" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content  animated bounceInRight"  aria-hidden="true" style=" padding: 1em;">
                <form action="{{url('company/confirmorder/'.$order->id)}}" method="post" class="form-horizontal">
                    @csrf
                    {{method_field('PUT')}}
                    <div class="form-group"><label class="col-sm-4 control-label" > المندوب </label>
                        <div class="col-sm-8">
                            <select name="representative" id="my_representative" class="form-control" required>
                                ...
                                @foreach($order->Company->Representatives as $representative)
