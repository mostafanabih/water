    ...
    <nav class="navbar-default navbar-static-side" role="navigation" >
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li <?php if(Request::path() == 'admin/city'): ?> class="active" <?php endif; ?>>
                    <a href="<?php echo e(url('admin/city')); ?>"><i class="fa fa-map-marker"></i> <span class="nav-label">المدن</span></a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\water\resources\views/admins/extends/header.blade.php ENDPATH**/ ?>